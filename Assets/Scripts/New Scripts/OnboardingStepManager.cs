...
public class OnboardingStepManager : MonoBehaviour
{
    ...
    public class Step
    {
        ...
        //public List<GameObject> gameObjectsToBeActivated;
    }
    ...
    private void LoadCurrentStep()
    {
        ...
        //// Activate all required game objects
        //foreach (var item in currentStep.gameObjectsToBeActivated)
        //{
        //    item.SetActive(true);
        //}
    }
    ...
    public void ResetOnboardingStage()
    {
        currentStepIndex = 0;
